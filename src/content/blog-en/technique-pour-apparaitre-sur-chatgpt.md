---
title: "Techniques to Appear on ChatGPT"
description: "Discover every technique to appear on ChatGPT: GEO optimization, structured data and content strategy for AI."
date: "2026-02-05"
author: "ruben-sebag"
category: "GEO"
...
- [Understanding how ChatGPT selects its sources](#understanding-how-chatgpt-selects-its-sources)
- [Optimizing your content structure and markup](#optimizing-your-content-structure-and-markup)
- [Creating content designed to be cited by AI](#creating-content-designed-to-be-cited-by-ai)
- [Strengthening your authority and credibility](#strengthening-your-authority-and-credibility)
- [Distribution and visibility strategy](#distribution-and-visibility-strategy)
- [Measuring and iterating on your presence in ChatGPT](#measuring-and-iterating-on-your-presence-in-chatgpt)
...
> "The content best cited by generative AIs is that which directly answers a question, in a structured and factual format, from the very first lines of a section."
...
- Verify that the **robots.txt** allows the `Bingbot` and `GPTBot` user agents
- Add an **llms.txt** file at the root of the site to inform AIs of the available content
